...
void set_device_props(void){
    ...
    std::string operator_code_raw, device, product_release_name, model, market_name, fingerprint;
    ...
    set_ro_build_prop("name", product_release_name);
    set_ro_build_prop("model", model);
    set_ro_build_prop("product", product_release_name);
